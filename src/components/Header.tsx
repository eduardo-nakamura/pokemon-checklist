...
export function Header () {
  ...
  const { language, isDarkMode, setLanguage, toggleDarkMode } =
    useSettingsStore()

  return (
    <header
      className={`w-full border-b px-6 py-4 relative z-50 transition-colors ${
        isDarkMode
    ...
    >
      <div className='max-w-5xl mx-auto flex justify-between items-center'>
        <div onClick={() => navigate('/')} className='cursor-pointer group'>
          ...
          >
            POKÉ
            <span className='text-red-600 group-hover:text-red-500'>CHECK</span>
          </h1>
        </div>
        ...
        <div className='relative'>
          ...
          {isOpen && (
            <>
              ...
              />
              <div
                className={`absolute right-0 mt-3 w-64 border rounded-2xl shadow-2xl p-2 animate-in fade-in zoom-in duration-200 ${
                  isDarkMode
